...
static DUSK_CONST actor_method_class l_daObj_Ito_Method = {
...
DUSK_PROFILE actor_process_profile_definition DUSK_CONST g_profile_OBJ_ITO = {
    /* Layer ID     */ fpcLy_CURRENT_e,
    /* List ID      */ 4,
    /* List Prio    */ fpcPi_CURRENT_e,
    /* Proc Name    */ fpcNm_OBJ_ITO_e,
    /* Proc SubMtd  */ &g_fpcLf_Method.base,
    /* Size         */ sizeof(obj_ito_class),
    /* Size Other   */ 0,
    /* Parameters   */ 0,
    /* Leaf SubMtd  */ &g_fopAc_Method.base,
    /* Draw Prio    */ fpcDwPi_OBJ_ITO_e,
    /* Actor SubMtd */ &l_daObj_Ito_Method,
